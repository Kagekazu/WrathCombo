            ...
            internal static void Draw(CustomComboPreset preset)
            {
                ...
                case CustomComboPreset.SGE_ST_DPS_Movement:
                    DrawHorizontalMultiChoice(SGE_ST_DPS_Movement, Toxikon.ActionName(),
                        $"Use {Toxikon.ActionName()} when Addersting == available.", 4, 0);

                    DrawHorizontalMultiChoice(SGE_ST_DPS_Movement, Dyskrasia.ActionName(),
                        $"Use {Dyskrasia.ActionName()} when in range of a selected enemy target.", 4, 1);

                    DrawHorizontalMultiChoice(SGE_ST_DPS_Movement, Eukrasia.ActionName(),
                        $"Use {Eukrasia.ActionName()}.", 4, 2);

                    DrawHorizontalMultiChoice(SGE_ST_DPS_Movement, Psyche.ActionName(), $"Use {Psyche.ActionName()}.",
                        4, 3);
                ...
                case CustomComboPreset.SGE_ST_Heal_EDiagnosis:
                    ...
                    DrawHorizontalMultiChoice(SGE_ST_Heal_EDiagnosisOpts, "Ignore Shield Check",
                        $"Warning, will force the use of {EukrasianDiagnosis.ActionName()}, and normal {Diagnosis.ActionName()} will be unavailable.",
                        2, 0);

                    DrawHorizontalMultiChoice(SGE_ST_Heal_EDiagnosisOpts, "Check for Scholar Galvenize",
